...
Widget arrowBack({
  ...
  double right = 10
    ...
    child: Padding(
      ...
      child: Image.asset("images/left-arrow.png",width: 22,height: 16,),
    ));
Widget fixoIcon({
  double width = 80,
  double height = 72,
})=> Image.asset("images/logo.png",width: width,height: height,);
...
defaultTextFormFieldMyAccount({
  ...
  TextInputType textInputType = TextInputType.name,
  double? horizontal = 0,
  Color labelTextColor = const Color(0xff182061),
  bool readOnly = false,

...
import 'package:santos/modelUi/carsoulUI.dart';
import 'package:santos/modelUi/mainService.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
                        Navigator.pushNamed(context, "SavedTitles");
                      },
                      child: Text(
                        'تغيير',
                        style: TextStyle(
              ...
              SlideImageList.map((e) {
                ...
                GridView.count(
                  ...
                  ...mainServiceUIList.map((e){
                    return  InkWell(
                      onTap: (){
                        Navigator.pushNamed(context, "Service_Request_2");
                      },
                      child: Container(
                       height: 108,
                        child: Column(

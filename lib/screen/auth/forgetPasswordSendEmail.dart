...
class ForgetPasswordSendEmail extends StatefulWidget {
   ForgetPasswordSendEmail({Key? key}) : super(key: key);

  @override
  State<ForgetPasswordSendEmail> createState() => _ForgetPasswordSendEmailState();
}

class _ForgetPasswordSendEmailState extends State<ForgetPasswordSendEmail> {
